...
export function getElements() {
  return {
    ...
    libraryTextBadge: document.getElementById("library-text-badge"),
    list: document.getElementById("message-list"),
    mapCanvas: document.getElementById("map-canvas"),
    mapDrawer: document.getElementById("map-drawer"),
    mapDrawerClose: document.getElementById("map-drawer-close"),
    mapDrawerList: document.getElementById("map-drawer-list"),
    mapDrawerTitle: document.getElementById("map-drawer-title"),
    mapEmpty: document.getElementById("map-empty"),
    mapMessagesBadge: document.getElementById("map-messages-badge"),
    mapPointsBadge: document.getElementById("map-points-badge"),
